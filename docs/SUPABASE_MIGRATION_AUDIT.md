...
**Canonical migrations:** `20260321130102–08` (teams, courses, storage, cms, cache, realtime, role constraint).  
See `supabase/migrations/README.md` for the full chain.
...
2. `npx supabase link --project-ref lfdttxwvjgypljuhgjeu`
