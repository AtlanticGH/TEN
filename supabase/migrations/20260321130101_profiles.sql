-- 001_profiles: extensions, profiles, core learning tables, base RLS

-- Align legacy/manual profiles schema with TEN app expectations (idempotent).
DO $$
BEGIN
  IF EXISTS (
...
-- Align courses if created from alternate template (status enum vs published boolean)
